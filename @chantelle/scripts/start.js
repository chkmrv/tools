...
import { appPublic, appHtml, appIndexJs, appPackageJson, yarnLockFile } from '../config/paths'
import { webpackDevelopmentConfig as config } from '@chantelle/config'
import createDevServerConfig from '../server/dev'
...
const debug = debugFactory('webpack-start')
...
const DEFAULT_PORT = parseInt(env.PORT, 10) || 3000
const HOST = env.HOST || '0.0.0.0'

debug('starting')
debug('HOST', HOST)
debug('DEFAULT_PORT', DEFAULT_PORT)
debug('appPublic', appPublic)
...
choosePort(HOST, DEFAULT_PORT)
  .then(port => {
    ...
    devServer.listen(port, HOST, err => {
      ...
      if (isInteractive && DISABLE_CLEAR_TERMINAL !== true)
        clearConsole()
